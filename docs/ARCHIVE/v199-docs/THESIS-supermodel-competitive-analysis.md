...
*Gitignored extraction: docs/v199-docs/supermodel-extracted/*
...
*Sources: Decompiled from docs/v199-docs/supermodel-extracted/ (gitignored) + GitHub repos supermodeltools/{openapi-spec,mcp,arch-docs,dead-code-hunter,typescript-sdk}. OpenAPI spec agent confirmed API v0.9.6 with 9 endpoints, 28 schemas, idempotency key requirement, and metered billing via X-Usage-Units header.*
