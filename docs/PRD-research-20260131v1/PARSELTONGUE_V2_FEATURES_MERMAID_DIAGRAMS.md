...
quadrantChart
    ...
    Feature 12 (Layers): [0.25, 0.88]
    Feature 5 (Entropy): [0.25, 0.87]
    Feature 1 (Modules): [0.35, 0.85]
    Feature 17 (Impact): [0.25, 0.83]
    Feature 2 (LPA): [0.2, 0.82]
    Feature 13 (SCC): [0.15, 0.80]
    Feature 7 (Cyclomatic): [0.12, 0.78]
    Feature 8 (Coupling): [0.22, 0.75]
    Feature 18 (Slicing): [0.35, 0.73]
    Feature 20 (UMAP): [0.35, 0.70]
    Feature 25 (Incremental): [0.35, 0.68]
    Feature 3 (K-Core): [0.22, 0.65]
    Feature 15 (Node2Vec): [0.35, 0.63]
    Feature 26 (Parallel): [0.22, 0.60]
    Feature 14 (WL Kernel): [0.35, 0.58]
    Feature 23 (Git Churn): [0.22, 0.55]
    Feature 4 (Spectral): [0.35, 0.52]
    Feature 21 (DSM): [0.22, 0.50]
    Feature 9 (Clones): [0.22, 0.48]
    Feature 27 (Compression): [0.22, 0.45]
    Feature 19 (Triangles): [0.22, 0.43]
    Feature 24 (Temporal): [0.22, 0.40]
    Feature 22 (Force): [0.22, 0.38]
    Feature 16 (RefDiff): [0.22, 0.35]
    Feature 10 (SARIF): [0.22, 0.33]
    Feature 28 (Approx): [0.35, 0.30]
```
